...
public class VideoCapture : MonoBehaviour
{
    ...
    public GameObject videoSelectButton;
    public GameObject videoTitleText;
    ...
    public void SetInputType(Int32 val)
    {
        DisableObjects();
        switch (val)
        {
            ...
            case 1:
                ...
                break;
            case 2 :
                videoTitleText.SetActive(true);
                videoList.SetActive(true);
                break;
            case 3 :
                videoSelectButton.SetActive(true);
                videoTitleText.SetActive(true);
                break;
        }
        ...
        void DisableObjects()
        {
            videoSelectButton.SetActive(false);
            videoTitleText.SetActive(false);
            videoList.SetActive(false);
            UseWebCam = false;
        }
    }

    public void SetVideoFromPresets(Int32 val)
    {
        switch (val)
        {
            case 0:
